...
order: 1
---
You can setup OpenNebula backed by [ceph](http://ceph.com) or [lvm](https://wiki.ubuntu.com/Lvm) to store images.

---

### Configuring OpenNebula

[MegamVertice](/) provides a marketplace for one click launches.  We need a running [OpenNebula](http://opennebula.org) with templates and images.
...
Hence a context shell script in directory */vertice* should be created initially. For guidance please read  the documentation [provided here](https://github.com/megamsys/gitpackager/blob/master/support/README.md).
