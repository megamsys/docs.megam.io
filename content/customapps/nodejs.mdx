...
[https://github.com/verticeapps/node_etherpad](https://github.com/verticeapps/node_etherpad.git)

[https://github.com/verticeapps/travis-web](https://github.com/verticeapps/travis-web.git)

[https://github.com/verticeapps/ghost](https://github.com/verticeapps/ghost.git)
...
For example,The Procfile is added in [verticeapps/etherpad-lite](https://github.com/verticeapps/etherpad-lite.git)
...
The Procfile is added in [verticeapps/node_hexo](https://github.com/verticeapps/node_hexo.git)
...
The Procfile is added in [verticeapps/node_c9](https://github.com/verticeapps/node_c9.git)
...
To make changes in the code [verticeapps/etherpad-lite](https://github.com/verticeapps/etherpad-lite.git) ensure that you have the build tools like **git**, **npm**, and **node** installed.
