...
[https://github.com/verticeapps/scala_fiddle](https://github.com/verticeapps/scala_fiddle.git)

[https://github.com/verticeapps/play-scala-fileupload-example](https://github.com/verticeapps/play-scala-fileupload-example.git)

[https://github.com/verticeapps/play-scala-rest-api-example](https://github.com/verticeapps/play-scala-rest-api-example.git)
...
For example,The Procfile is added in [verticeapps/scala_fiddle.git](https://github.com/verticeapps/scala_fiddle.git)
...
The Procfile is added in [verticeapps/play-scala-fileupload-example.git](https://github.com/verticeapps/play-scala-fileupload-example.git)
...
To make changes in the code [verticeapps/scala_fiddle.git](https://github.com/verticeapps/scala_fiddle.git) ensure that you have the build tools like **git**, **sbt** installed.
