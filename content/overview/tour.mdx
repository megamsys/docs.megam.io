...
![Launching VM](/img/machines/deploy.gif)

Our upcoming panel changes for 2.0 release is shown [here](https://forum.megam.io).
...
![Launching App - Bitnami](/img/prepackaged/bitnami.gif)
...
![Launching Container - Ubuntu](/img/containers/deploy.gif)
...
![Attach Block Storage](/img/machines/attach_disk.gif)
...
![Take a Snapshot](/img/machines/take_snapshot.gif)
...
![Realtime monitoring/Logging](/img/machines/realtime_monitlogging.gif)
...
![Launching CustomApp - Java](/img/customapps/deploy.gif)
...
![Launching VM using multiple regions](/img/machines/deploy.gif)
...
[MegamVertice WHMCS Add-on](https://github.com/megamsys/gitpackager) is inscribed in PHP.
...
![Store your file](/img/machines/deploy.gif)
